...
ESP32RGBPanel::ESP32RGBPanel(
    int8_t de, int8_t vsync, int8_t hsync, int8_t pclk, int8_t r0, int8_t r1,
    int8_t r2, int8_t r3, int8_t r4, int8_t g0, int8_t g1, int8_t g2, int8_t g3,
    int8_t g4, int8_t g5, int8_t b0, int8_t b1, int8_t b2, int8_t b3, int8_t b4,
    ...
    : _de(de), _vsync(vsync), _hsync(hsync), _pclk(pclk), _r0(r0), _r1(r1),
      ...
      _prefer_speed(prefer_speed), _useBigEndian(useBigEndian),
      _de_idle_high(de_idle_high), _pclk_idle_high(pclk_idle_high) {}

bool ESP32RGBPanel::begin(int32_t speed) {
...
uint16_t *ESP32RGBPanel::getFrameBuffer(int16_t w, int16_t h) {
  ...
  // ESP_ERROR_CHECK(_panel_handle->draw_bitmap(_panel_handle, 0, 0, 1, 1,
  // &color));
